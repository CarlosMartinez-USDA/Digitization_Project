...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="marc:record">
            ...
            <xsl:if
                ...
                <xsl:choose>
                <xsl:when test="marc:datafield[@tag='945']/marc:subfield[@code='v']!=''">
                    <xsl:if test="position() mod 3=0">
                        <marc:datafield tag="945" ind1=" " ind2=" ">
                        <xsl:apply-templates select="marc:datafield[@tag='945']/marc:subfield[@code='a' or @code='v' or @code='p']">
                            <xsl:with-param name="subfieldCode">
                                <marc:subfield code="{@*}">
                    ...
                    <xsl:when test="count(marc:datafield[@tag='945']/marc:subfield[@code='p'] > 1)">
                            <marc:datafield tag="945" ind1=" " ind2=" ">
                                <xsl:apply-templates select="marc:datafield[@tag='945']/marc:subfield[@code='a' or @code='p']">
                                    <xsl:with-param name="subfieldCode">
                                        <marc:subfield code="{@*}">
                                            <xsl:apply-templates select="marc:datafield[@tag='945']/marc:subfield[@code='a'] | marc:datafield[@tag='945']/marc:subfield[@code='v']| marc:datafield[@tag='945']/marc:subfield[@code='p']"/>
                                        </marc:subfield> 
