...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xd:doc id="group-945.xsl" scope="stylesheet"><xd:desc>       
    ...
    <xd:doc><xd:desc>Identity template</xd:desc>
    </xd:doc>
    ...
    <xd:doc><xd:desc>Rebuilds marc:record, correcting DigiMet metadata.</xd:desc></xd:doc>
    ...
    <xd:doc><xd:desc>Calls subfields for legacy data</xd:desc></xd:doc>
    ...
    <xd:doc><xd:desc>Used for both legacy and digimet subfield processing.</xd:desc><xd:param name="subfieldCode"/></xd:doc>
