...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xd:doc id="group-945.xsl" scope="stylesheet">
        <xd:desc>       
            ...
            <xd:p><xd:b>Date last modified: </xd:b>December 4, 2024</xd:p>
    ...
    <xd:doc>
        <xd:desc>Rebuilds marc:record according to the project output requirements.</xd:desc>
    </xd:doc>
    ...
    <xd:doc>
        <xd:desc>Calls subfields for legacy data</xd:desc>
    </xd:doc>
    ...
    <xd:doc>
    <xd:desc>Used for both legacy and digimet subfield processing.</xd:desc>
    ...
    <xsl:template match="marc:subfield[@code]" mode="subfield">
        ...
        <xsl:for-each select="current-grouping-key()">
            <!-- cast as a node -->
            <marc:subfield code="{current-grouping-key()}">
