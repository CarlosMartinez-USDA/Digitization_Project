...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns="http://www.loc.gov/MARC21/slim" xmlns:f="http://functions" xmlns:local="http://www.loc.org/namespace" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
    ...
    <xd:doc id="digitization.xsl" scope="stylesheet"><xd:desc>
            ...
            <xd:p><xd:b>Purpose: </xd:b>This stylesheet concatenates marc subfields "a","p" and "v" within local datafield, "945". The purpose is to capture DigiMet data.</xd:p>
        </xd:desc></xd:doc>
 ...
 -->
    ...
    <xd:doc id="identity" scope="component"><xd:desc>Identity template</xd:desc></xd:doc>
    ...
    <xd:doc id="root" scope="stylesheet"><xd:desc>
            <xd:p>Root: wraps marc:records in the marc:collection document node</xd:p>
        </xd:desc></xd:doc>
    <xsl:template match="/">
        <xsl:result-document version="1.0" encoding="utf-8" format="group-945" href="{replace(base-uri(),'(.*/)(.*)(\.xml)','$1')}N-{replace(base-uri(), '(.*/)(.*)(\.xml)','$2')}_{position()}.xml">
            <marc:collection xmlns="http://www.loc.gov/MARC21/slim" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/MARC21/slim http://www.loc.gov/standards/marcxml/schema/MARC21slim.xsd">
